...
list_reallohn_week_teilzeit_FB = [reallohn_2014_teilzeit_FB, reallohn_2015_teilzeit_nb_FB, reallohn_2015_teilzeit_FB]
list_reallohn_week_mini_FB = [reallohn_2014_mini_FB, reallohn_2015_mini_nb_FB, reallohn_2015_mini_FB]


# create plot
n_groups = 3
fig, ax = plt.subplots()
fig.canvas.set_window_title('Mindestlohn Neue Bundesländer')
...
rects1 = plt.bar(index + 0.00, list_reallohn_week_vollzeit_FB, bar_width,
                 alpha=opacity,
                 color='b',
                 label='Vollzeit')
rects2 = plt.bar(index + bar_width, list_reallohn_week_teilzeit_FB, bar_width,
                 alpha=opacity,
                 color='g',
                 label='Teilzeit')
rects3 = plt.bar(index + bar_width * 2, list_reallohn_week_mini_FB, bar_width,
                 alpha = opacity,
                 color='c',
                 label='Mini Job')
...
plt.ylabel('EUR')
plt.title('Reallöhne pro Woche / Neue Bundesländer')
...
# print(reallohn_2015_vollzeit_nb_FB + ' - ' + reallohn_2014_vollzeit_FB)
# print(reallohn_2015_vollzeit_FB + ' - ' + reallohn_2015_vollzeit_FB)

list_reallohn_week_vollzeit_FB_diff = [reallohn_2015_vollzeit_nb_FB - reallohn_2014_vollzeit_FB, reallohn_2015_vollzeit_FB - reallohn_2014_vollzeit_FB]

list_reallohn_week_teilzeit_FB_diff = [reallohn_2015_teilzeit_nb_FB - reallohn_2014_teilzeit_FB, reallohn_2015_teilzeit_FB - reallohn_2014_teilzeit_FB]

list_reallohn_week_mini_FB_diff = [reallohn_2015_mini_nb_FB - reallohn_2014_mini_FB, reallohn_2015_mini_FB - reallohn_2014_mini_FB]


rects1 = plt.bar(index + 0.00, list_reallohn_week_vollzeit_FB_diff, bar_width,
                 alpha=opacity,
                 color='b',
                 label='Vollzeit')
rects2 = plt.bar(index + bar_width, list_reallohn_week_teilzeit_FB_diff, bar_width,
                 alpha=opacity,
                 color='g',
                 label='Teilzeit')
rects3 = plt.bar(index + bar_width * 2,list_reallohn_week_mini_FB_diff, bar_width,
                 alpha = opacity,
                 color='c',
                 label='Mini Job')
...
plt.ylabel('EUR')
plt.title('Differenzen der Reallöhne pro Woche / Neue Bundesländer')
plt.xticks(index + bar_width, label_week_lists)
plt.legend(bbox_to_anchor=(1, 1),
           bbox_transform=plt.gcf().transFigure)
